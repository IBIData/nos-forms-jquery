...
; (function ($, window, document, undefined) {
        ...
        this.getAttrs = function (input) {
            ...
            this.getElements = {
                ...
                check: function (input) {
                    ...
                    $.each(inputOptions, function (k, v) {
                        if (typeof input.checked === 'object' || input.checked === undefined) {
                            checked = $.inArray(k, input.checked) > -1 ? ' checked' : '';
                        } else if (typeof input.checked === 'string') {
                            checked = k === input.checked ? ' checked' : '';
                        } else {
                ...
                clone: function (input) {
                    ...
                    for (i = 1; i < maxFields; i++) {
                        ...
                        hideFields = i <= startFields ? '' : ' hidden';
            ...
            this.userErrorMessage = {
                ...
                required: function (el) {
                    var message = el.messages ? el.messages.required : null;
                ...
                valid: function (el) {
                    var message = el.messages ? el.messages.invalid : null;
                ...
                minlength: function (el) {
                    var message = el.messages ? el.messages.minlength : null;
                ...
                maxlength: function (el) {
                    var message = el.messages ? el.messages.maxlength : null;
                ...
                min: function (el) {
                    var message = el.messages ? el.messages.min : null;
                ...
                max: function (el) {
                    var message = el.messages ? el.messages.max : null;
            ...
            this.validate = function (fields) {
                ...
                function minLength(v) {
                    ...
                    $(id).on('keyup change blur focus paste', function () {
                        ...
                        if (minval > 0) {
                            if (minval < v.minlength) {
                                $(msg).nosSlideDown();
                                $(this).alterClass('nos-valid-minlength', 'nos-invalid-minlength');
                            } else {
                                $(msg).nosSlideUp();
                                $(this).alterClass('nos-invalid-minlength', 'nos-valid-minlength');
                            }
                        } else {
                            $(msg).nosSlideUp();
                ...
                function minMax(v) {
                    ...
                    $(id).on('keyup change blur focus paste submit', function () {
                        ...
                        if (numVal > 0) {
                            if (numVal < v.min) {
                                $(minMsg).nosSlideDown();
                                $(this).alterClass('nos-valid-min', 'nos-invalid-min');
                            } else {
                                $(minMsg).nosSlideUp();
                                $(this).alterClass('nos-invalid-min', 'nos-valid-min');
                            }
                            if (numVal > v.max) {
                                $(maxMsg).nosSlideDown();
                                $(this).alterClass('nos-valid-max', 'nos-invalid-max');
                            } else {
                                $(maxMsg).nosSlideUp();
                                $(this).alterClass('nos-invalid-max', 'nos-valid-max');
                            }
                        } else {
                            $(minMsg).nosSlideUp();
                    ...
                    $(id).on('keyup change blur focus paste', function () {
                        if ($(this).val().length > 0) {
                            if (regex.test($(this).val())) {
                                $(msg).nosSlideUp();
                                $(this).alterClass('nos-invalid-pattern', 'nos-valid-pattern');
                            } else {
                                $(msg).nosSlideDown();
                                $(this).alterClass('nos-valid-pattern', 'nos-invalid-pattern');
                            }
                        }
                        else {
                            $(msg).nosSlideUp();
                ...
                function passwordMatch(v) {
                    ...
                    $(pwd + ',' + id).on('keyup change blur paste focus', function () {
                        if ($(pwd).val().length > 0) {
                            if ($(id).val() !== $(pwd).val()) {
                                $(msg).nosSlideDown();
                                $(pwd + ',' + id).alterClass('nos-valid-match', 'nos-invalid-match');
                            } else {
                                $(msg).nosSlideUp();
                                $(pwd + ',' + id).alterClass('nos-invalid-match', 'nos-valid-match');
                            }
                        } else {
                            $(msg).nosSlideUp();
                    ...
                    $(id).on('keyup input change blur paste focus', function () {
                        switch (v.type) {
                            ...
                            case 'email':
                                emval = $(this).val();
                                if (emval.length > 0) {
                                    if (self.validator.email(emval)) {
                                        $(msg).nosSlideUp();
                                        $(this).alterClass('nos-invalid-email', 'nos-valid-email');
                                    } else {
                                        $(msg).nosSlideDown();
                                        $(this).alterClass('nos-valid-email', 'nos-invalid-email');
                                    }
                                }
                                if (emval === '') {
                                    $(msg).nosSlideUp();
                                    $(this).removeClass('nos-invalid-email nos-valid-email');
                                }
                                break;
                            ...
                            case 'zip':
                                ...
                                if ($.mask && v.mask) {
                                    if ($(this).caret().begin > 0) {
                                        if (self.validator.zipcode(emval)) {
                                            $(msg).nosSlideUp();
                                            $(this).alterClass('nos-invalid-zip', 'nos-valid-zip');
                                        } else {
                                            $(msg).nosSlideDown();
                                            $(this).alterClass('nos-valid-zip', 'nos-invalid-zip');
                                        }
                                    }
                                    if ($(this).caret().end === 0) {
                                        $(msg).nosSlideUp();
                                        $(this).removeClass('nos-invalid-zip nos-valid-zip');
                                    }
                                } else {
                                    if (emval.length > 0) {
                                        if (self.validator.zipcode(emval)) {
                            ...
                            case 'tel':
                                ...
                                if ($.mask && v.mask) {
                                    if ($(this).caret().begin > 0) {
                                        if (self.validator.phone(emval)) {
                                            $(msg).nosSlideUp();
                                            $(this).alterClass('nos-invalid-tel', 'nos-valid-tel');
                                        } else {
                                            $(msg).nosSlideDown();
                                            $(this).alterClass('nos-valid-tel', 'nos-invalid-tel');
                                        }
                                    }
                                    if ($(this).caret().end === 0) {
                                        $(msg).nosSlideUp();
                                        $(this).removeClass('nos-invalid-tel nos-valid-tel');
                                    }
                                } else {
                                    if (emval.length > 0) {
                                        if (self.validator.phone(emval)) {
                ...
                function addMask(v) {
                    if ($.mask) {
                        ...
                        console.warn('You must include the masked input plugin to use "mask". Go here: https://github.com/digitalBush/jquery.maskedinput');
                    }
                ...
                function cloneButtons() {
                    ...
                    $($form + ' [data-nos-add-button]').click(function () {
                        if ($($form + ' .nos-input-group.hidden').length > 0) $('.nos-input-group.hidden').eq(0).removeClass('hidden');
                        if ($($form + ' .nos-input-group.hidden').length === 0) $(this).addClass('disabled');
                        if ($($form + ' .nos-input-group:not(.hidden)').length > 1) $('[data-nos-remove-button]').removeClass('disabled');
                    });

                    // clone field remove button functionality
                    $($form + ' [data-nos-remove-button]').click(function () {
                        if ($($form + ' .nos-input-group:not(.hidden)').length > 1) $('.nos-input-group:not(.hidden)').eq(-1).addClass('hidden');
                        if ($($form + ' .nos-input-group:not(.hidden)').length === 1) $(this).addClass('disabled');
                        if ($($form + ' .nos-input-group.hidden').length > 0) $('[data-nos-add-button]').removeClass('disabled');
                    });
                }
            ...
            this.submitValidation = function (data) {
                ...
                function checkRequiredFields() {
                    requiredFields.each(function () {
                        if ($(this).val().length < 1) {
                            $(this).alterClass('nos-valid-required', 'nos-invalid-required');
                        } else {
                            $(this).alterClass('nos-invalid-required', 'nos-valid-required');
                        }
                    ...
                    cb.each(function (i) {
                        ...
                        $(checkboxes).each(function () {
                            ...
                            $(this).change(function () {
                                if ($.inArray($(this).val(), cba[i]) > -1) {
                                    cba[i].splice($.inArray($(this).val(), cba[i]), 1);
                                } else {
                                    cba[i].push($(this).val());
                                }
                                if (cba[i].length > 0) {
                ...
                function submitForm() {
                    ...
                    // if there are untouched required fields or if an error message is displayed
                    ...
                    //
                        ...
                        if ($($form + ' .nos-required').is(':visible')) $($form + ' .nos-form-required').nosSlideDown();
                        if ($($form + ' .nos-invalid').is(':visible')) $($form + ' .nos-form-invalid').nosSlideDown();
                        $($form + ' [data-nos]').on('change input keyup blur focus paste', function () {
                            if ($($form + ' .nos-invalid').is(':visible')) {
                                $($form + ' .nos-form-invalid').nosSlideDown();
                            } else {
                                $($form + ' .nos-form-invalid').nosSlideUp();
                            }
                            if ($($form + ' .nos-required').is(':visible')) {
                                $($form + ' .nos-form-required').nosSlideDown();
                            } else {
                                $($form + ' .nos-form-required').nosSlideUp();
                            }
                        });
                    }
                }
                ...
                function send() {
                    if (self.settings.honeypot) {
                        if ($($form + ' .nos-text-css').val() === '' && $($form + ' .nos-email-js').val() === 'validemail@email.com') {
                            ...
                            self.settings.submit({ honeypot: true });
                        }
                    }
                    else {
                        self.settings.submit(formdata);
    ...
    $.extend(Nos.prototype, {
        init: function () {
            ...
            // run validation
            if (this.settings.validate) {
                this.validate(this.settings.fields);
                this.addMessage();
            }
